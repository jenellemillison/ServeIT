...
business_data_clean_agg = business_data_clean.groupby(['County_Name', 'NAICS_Description'], as_index=False).aggregate(aggregation_functions)
...
business_data_clean_final.sort_values(by=["County_Name"], inplace = True)
